...
({
    ...
    onFocus : function(component,event,helper){
        ...
        if (component.get("v.showRecent") && searchText.length <=0) {
            ...
            action.setCallback(this, function(response) {
                var results = response.getReturnValue();
                if (results != null) {
                    component.set("v.statusMessage", results.length > 0 ? null : 'Não há registros recentes' );
    ...
    onKeyUp : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            var results = response.getReturnValue();
            if (results != null) {
                component.set("v.statusMessage", results.length > 0 ? null : 'Nenhum registro encontrado' );
                component.set("v.searchResult", 
